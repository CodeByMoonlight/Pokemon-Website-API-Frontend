  ...
  return (
    <ChartContext.Provider value={{ config }}>
      ...
      >
        ...
        <div className="pb-15 relative flex w-2.5 flex-col justify-between pl-5 pt-10">
                ...
                <>
                  {itemConfig?.icon ? (
                    ...
                    !hideIndicator && (
                      <div
                        className={cn(
                          "border-(--color-border) bg-(--color-bg) shrink-0 rounded-sm",
                          {
